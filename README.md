...
- `CNN-P4.mat` — trained CNN model
- `LSTM-P4.mat` — trained LSTM model
- `for_CNN_P4.m` — example prediction script for the CNN model
- `for_LSTM_P4.m` — example prediction script for the LSTM model
